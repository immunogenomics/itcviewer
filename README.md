...
- [Dr. Patrick J. Brennan](https://connects.catalyst.harvard.edu/Profiles/display/Person/56904)
- [Dr. Soumya Raychaudhuri](https://immunogenomics.hms.harvard.edu/)
- [Dr. Michael B. Brenner](https://www.hms.harvard.edu/dms/immunology/fac/Brenner.php)

Download the data from NCBI GEO:

- [GSE124731](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE124731)

## :octocat: Get the code

Get the code for the analysis in the paper:

- https://github.com/immunogenomics/itc

Get the code for the data viewer:

- https://github.com/immunogenomics/itcviewer
